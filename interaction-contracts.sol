...
contract Call {
  ...
  // This function is called when ever someone sends ethers to this contract's address: the fallback function
  function () payable {
    ...
    BinaryTrading mainContract = BinaryTrading(mainContractAddress);
    mainContract.call();
